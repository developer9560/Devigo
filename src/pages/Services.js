...
const Services = () => {
  ...
  // Structured data for services list page
  ...
  return (
    <>
      <SEO 
        title="Our Services | Web, Mobile & Digital Solutions | Devigo"
        description="Explore our professional web development, mobile app, UI/UX design, and digital marketing services. Custom solutions tailored to meet your business needs."
        keywords="WordPress Development: WordPress website development, WordPress developer, WordPress design services, WordPress development company, WordPress development agency, hire WordPress developer, custom WordPress development, WordPress plugin development, WordPress theme development, WordPress e-commerce development, affordable WordPress development, WordPress web design, best WordPress developers, WordPress site development services, WordPress maintenance services, WordPress development services India.
Custom Software Development: custom software development, custom software development company, software development company, software development services, custom application development, enterprise software solutions, software engineering firm, software development agency, SaaS development company, software outsourcing company, offshore software development, software development firm, bespoke software development, software development consultant, custom application development company, top software companies, fintech software development, healthcare software development, custom financial software, custom healthcare software, custom ERP software solutions, custom CRM development, industrial software development.
Android & Mobile App Development: Android app development, Android app developer, Android application development company, mobile app development company, mobile app developer, iOS and Android app development, cross-platform app development, React Native app development, Flutter app development, native Android app development, mobile application development services, enterprise mobile apps, Android app consulting, Android developer India, Android app development Delhi.
Web Design & UI/UX: web design company, responsive web design, user interface design, user experience design, UX/UI design, UI/UX agency, UI design services, UX design company, website redesign services, website UI design, mobile app UI design, professional UI design, UI/UX design studio, user experience consultancy, UI/UX design agency, UI/UX design company
seopital.co
, UI UX design services, UI UX developer, best UI/UX design, UI/UX consulting, UI/UX design firm, graphic UI/UX design.
E-commerce & CMS: e-commerce website development, Shopify development, Magento development, WooCommerce development, e-commerce web design, Drupal web development, Joomla development, CMS development company, custom CMS solutions.
Digital Marketing & SEO (supporting terms): (Since site mentions digital marketing) SEO services, online marketing services, digital marketing company, social media marketing.
Location-Specific Keywords (Delhi & Faridabad): web development Delhi, software company Delhi, Android app development Delhi, web design Faridabad, IT services Faridabad, WordPress development Delhi, custom software Faridabad, Android developer Faridabad, mobile app company Delhi, Delhi NCR web development, Delhi UI/UX design, web development services in Delhi, app developer in Faridabad, Delhi web design agency, Faridabad software solutions, best web developer Delhi."
        canonicalUrl="https://devigo.in/services"
        ogTitle="Professional Web & Mobile Development Services | Devigo"
        ogDescription="From web and mobile app development to UI/UX design and digital marketing - we deliver end-to-end digital solutions for businesses of all sizes."
        structuredData={services.length > 0 ? servicesSchema : null}
      />
